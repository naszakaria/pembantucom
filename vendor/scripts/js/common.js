// Scroll Hide/Show HTML Element Function
setTimeout(function() { 
    var $hideShowHtmlElement = $('#showhide_placeholder'),
            scroll_hide_show_event_fire = false;
    $hideShowHtmlElement.on()
            .data('hidden', 1).hide("slow");
//    $(window).on('scroll', function () {
//        scroll_hide_show_event_fire = true;
//    });
    ...
    $(document).on({
		...
		setInterval( function() {
			...
			if( scroll_hide_show_event_fire ) {
				...
				*/
				...
				var is_hidden =  $hideShowHtmlElement.data('hidden'); 
				...
				*/
				if ( is_hidden ) {
						...
						$hideShowHtmlElement.fadeIn(600).data('hidden', 0);
						...
						$hideShowHtmlElement.fadeOut().data('hidden', 1); //slideUp
...
// Bootstrap Accordion on Mouse Hover
$(function() {    
    $('#alternate-maid-acord').on('mouseenter.collapse', '[data-toggle=collapse]', function(e) {
        var $this = $(this),
